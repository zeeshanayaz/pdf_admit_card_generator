...
def create_admit_card_overlay(c, x, y, student_data):
    ...
    # c.drawString(x + 70, y + 55, f"{student_data['Campus']}")
...
# Ensure each overlay page is merged with a fresh copy of the background template
...
print(f"Admit cards generated successfully in '{output_pdf}'!")